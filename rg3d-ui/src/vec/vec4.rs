use crate::{
    ...
    message::{
        MessageDirection, NumericUpDownMessage, UiMessage, UiMessageData, Vec4EditorMessage,
    },
...
crate::define_widget_deref!(Vec4Editor);

impl Control for Vec4Editor {
...
pub struct Vec4EditorBuilder {
    widget_builder: WidgetBuilder,
    value: Vector4<f32>,
}

impl Vec4EditorBuilder {
