...
#[macro_export]
macro_rules! define_newtype_resource {
    ($name:ident, $actual_type:ty) => {
        #[derive(Default, Clone, Debug)]
        pub struct $name($crate::Resource<$actual_type>);

        impl std::ops::Deref for $name {
            type Target = $crate::Resource<$actual_type>;
        ...
        impl $crate::core::TypeUuidProvider for $name {
            fn type_uuid() -> $crate::core::uuid::Uuid {
                self.0.type_uuid()
            }
        }

        impl $crate::core::visitor::Visit for $name {
            fn visit(
                &mut self,
                name: &str,
                visitor: &mut $crate::core::visitor::Visitor,
            ) -> $crate::core::visitor::VisitResult {
        ...
        impl $crate::core::reflect::Reflect for $name {
            $crate::core::newtype_reflect!();
        }

        impl std::future::Future for $name {
            type Output = Result<$crate::Resource<$actual_type>, $crate::state::LoadError>;
